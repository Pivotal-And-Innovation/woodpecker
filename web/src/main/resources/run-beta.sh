...
APP_HOME=/data/woodpecker/woodpecker.web-1.0-SNAPSHOT.jar
 
#java�������������
JAVA_OPTS="-server  -Xms512m -Xmx512m -Xmn512m -Xss256k -XX:PermSize=256M -XX:MaxPermSize=512M -XX:SurvivorRatio=8 -XX:MaxTenuringThreshold=5
...
-XX:+PrintClassHistogram -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintHeapAtGC -Xloggc:/data/woodpecker/gc.log";
