...
public class MConsumer {
    ...
    public static void main(String[] args) throws InterruptedException, MQClientException {
         ...
         */
        String maGroup = "consumer.riskmanage.analysis";
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(maGroup);
        ...
        consumer.registerMessageListener(new MessageListenerConcurrently() {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msg,
                ...
                MessageExt msgExt = msg.get(0);
                if (msgExt.getTopic().equals("broker-a")) {
                    // 执行TopicTest1的消费逻辑
                    if (msgExt.getTags() != null && msgExt.getTags().equals("TagA")) {
                        // 执行TagA的消费
                        String message = new String(msgExt.getBody());
                        System.out.println(message);
                    }
                    else if (msgExt.getTags() != null && msgExt.getTags().equals("TagB")) {
                        // 执行TagB的消费
                        String message = new String(msgExt.getBody());
                        System.out.println(message);
                    }
