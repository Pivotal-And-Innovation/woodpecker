...
import com.sankuai.qcs.core.polygon.entity.LatLng;

import java.util.ArrayList;
import java.util.List;
import java.util.Stack;

import static com.sankuai.qcs.util.MathUtil.*;
...
public final class PolyUtil {
    ...
    public static List<LatLng> simplify(List<LatLng> poly, double tolerance) {
        ...
        if (closedPolygon) {
            ...
            poly.add(new LatLng(lastPoint.getLatitude() + OFFSET, lastPoint.getLongitude() + OFFSET));
        }
    ...
    public static double distanceToLine(final LatLng p, final LatLng start, final LatLng end) {
        ...
        LatLng sa = new LatLng(p.getLatitude() - start.getLatitude(), p.getLongitude() - start.getLongitude());
        LatLng sb = new LatLng(u * (end.getLatitude() - start.getLatitude()), u * (end.getLongitude() - start.getLongitude()));
